...
{{--                            <input--}}
{{--                                type="number" name="filters[price][from]"--}}
{{--                                value="{{request('filters.price.from',0)}}"--}}
{{--                                   class="w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition" placeholder="От">--}}
{{--                            <span class="text-body text-sm font-medium">–</span>--}}
{{--                            <input--}}
{{--                                type="number" name="filters[price][to]"--}}
{{--                                value="{{request('filters.price.to',100000)}}"--}}
{{--                                   class="w-full h-12 px-4 rounded-lg border border-body/10 focus:border-pink focus:shadow-[0_0_0_3px_#EC4176] bg-white/5 text-white text-xs shadow-transparent outline-0 transition" placeholder="До">--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                   @checked(request('filters.brands.'.$brand->id)) id="filters-brands-{{$brand->id}}" value="{{$brand->id}}" >--}}
