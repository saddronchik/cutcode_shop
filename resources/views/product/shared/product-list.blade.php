<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="{{route('product',$item->slug)}}" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
        ...
        {{--        <img src="{{asset($item->thumbnail)}}" class="object-cover w-full h-full" alt="{{$item->title}}">--}}
    </a>
    <div class="grow flex flex-col py-8 px-6">
        ...
        <ul class="space-y-1 mt-4 text-xxs">
            <li class="flex justify-between text-body"><strong>Вес (г): </strong> 98</li>
            <li class="flex justify-between text-body"><strong>Тип сенсора: </strong> Оптический</li>
            <li class="flex justify-between text-body"><strong>DPI: </strong> 180000</li>
            <li class="flex justify-between text-body"><strong>Кол-во кнопок: </strong> 6</li>
